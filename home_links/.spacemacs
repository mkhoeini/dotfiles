  ...
  (setq-default
   ...
   '(lua
     ...
     (org :variables
          ...
          ;; jiralib-url "https://spotify.atlassian.net:443"
          org-want-todo-bindings t
          org-todo-dependencies-strategy 'naive-auto
          org-directory "~/Documents/org"
          org-roam-directory (file-truename "~/Documents/org-roam")
          org-default-notes-file "~/Documents/org/notes.org"
          org-agenda-files '("." "./diary.org" "./journal/")
          diary-file "~/Documents/org/diary.org"
          org-journal-dir "~/Documents/org/journal/"
          org-journal-file-format "%Y/%B/%W.org"
     ...
     ;; (wakatime :variables
     ;;           wakatime-api-key  "94fb0dba-0bed-45a0-8ec4-d1dbc9278f67"
...
before packages are loaded."
  ...
  ;; Key Bindings
  (keymap-unset evil-motion-state-map (kbd "\\"))
  (spacemacs/declare-prefix "o" "custom")
  (spacemacs/set-leader-keys  "oC" 'calendar)
  (evil-global-set-key 'normal (kbd "\\C") 'calendar)
  (spacemacs/set-leader-keys "oj" 'org-journal-new-date-entry)
  (evil-global-set-key 'normal (kbd "\\j") 'org-journal-new-date-entry)
